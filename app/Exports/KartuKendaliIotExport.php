...
class KartuKendaliIotExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    ...
    public function map($kartu): array
    {
        ...
        return [
            $no++,
            $kartu->inspectable->kode_perangkat ?? '-',
            $kartu->inspectable->nama_inventaris ?? '-',
            $kartu->inspectable->kategori ?? '-',
            $kartu->inspectable->jenis ?? '-',
            $kartu->inspectable->lokasi ?: '-',
