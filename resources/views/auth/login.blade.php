...
<head>
    ...
    <title>Login - {{ config('app.name', 'SimLab') }}</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <p class="text-center text-xs text-gray-400 mt-6">&copy; {{ date('Y') }} SimLab. All rights reserved.</p>
    </div>
