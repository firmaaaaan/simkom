...
@section('header', 'Import Data Hardware')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h2 class="text-lg font-bold text-gray-800 mb-2">Import Hardware dari Excel</h2>
        <p class="text-sm text-gray-500 mb-6">Upload file Excel (.xlsx, .xls, .csv) untuk mengimport data hardware secara batch.</p>
        ...
        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-700 mt-1">Kode bersifat opsional. Jika kosong, kode akan di-generate otomatis (HW-001, HW-002, ...).</p>
                </div>
            </div>
        </div>

        <div class="mb-6">
            <a href="{{ route('hardware.template') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-green-600 text-green-600 text-sm font-medium rounded-lg hover:bg-green-50 transition-colors">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <form action="{{ route('hardware.store-import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('hardware.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Batal</a>
            </div>
        </form>
    </div>
</div>
