            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $hardware->quantity) }}" required min="0"
                            class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent placeholder-gray-400">
                    </div>
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="Digunakan" {{ old('status', $hardware->status) === 'Digunakan' ? 'selected' : '' }}>Digunakan</option>
                            <option value="Rusak" {{ old('status', $hardware->status) === 'Rusak' ? 'selected' : '' }}>Rusak</option>
                            <option value="Maintenance" {{ old('status', $hardware->status) === 'Maintenance' ? 'selected' : '' }}>Maintenance</option>
                        </select>
                    </div>
                </div>
