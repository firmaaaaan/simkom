...
<head>
    ...
    <title>Lacak Peminjaman - {{ config('app.name', 'SimKom') }}</title>
...
<body class="bg-gray-50 font-sans antialiased min-h-screen flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-black text-gray-900 mb-2">Lacak Peminjaman</h1>
                <p class="text-gray-500">Masukkan kode tracking peminjaman Anda</p>
            </div>
                ...
                <form action="" method="GET" id="trackForm" class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="tracking_code" id="trackingCode" required
                            ...
                            maxlength="13">
                        <p class="text-xs text-gray-400 mt-2 text-center">Format: BMJ- diikuti 8 karakter</p>
                    </div>
                    <button type="submit"
                        class="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-200">
                        Lacak Sekarang
                    </button>
                </form>
            </div>
    ...
    <script>
        document.getElementById('trackForm').addEventListener('submit', function(e) {
            ...
            if (code) {
                window.location.href = '/pinjam-komputer/track/' + code;
            }
        });
    </script>
