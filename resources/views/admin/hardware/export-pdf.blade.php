...
<head>
    <meta charset="utf-8">
    <title>Laporan Data Hardware</title>
    <style>
...
<body>
    <div class="header">
        <h1>Laporan Data Hardware</h1>
        <p>Tanggal: {{ now()->translatedFormat('d F Y H:i') }}</p>
        <p>Total: {{ $hardware->count() }} data</p>
    </div>
    ...
    <table>
        <thead>
            <tr>
                <th class="no">No</th>
                <th class="kode">Kode Hardware</th>
                <th class="nama">Nama Hardware</th>
