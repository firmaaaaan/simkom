...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Import Software</h4>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Import Data Software</h5>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <a href="{{ route('admin.software.export.excel') }}" class="btn btn-warning">
                        <i class="bx bx-download me-1"></i> Download Template Excel
                    </a>
                </div>
                <form method="POST" action="{{ route('admin.software.import') }}" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    <div class="col-md-6">
