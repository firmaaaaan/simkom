...
@section('title', 'Import Inventaris IoT & Jaringan')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Import Inventaris IoT & Jaringan</h4>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Import Data Inventaris</h5>
                <small class="text-muted">Format yang didukung: Excel (.xlsx)</small>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.inventaris-iot-jaringan.import.excel') }}" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    <div class="col-md-6">
