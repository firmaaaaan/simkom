...
<head>
    ...
    <title>Print Kartu Kendali - {{ $inventaris_iot_jaringan->nama_inventaris }}</title>
    <style>
...
<body>
    <div class="no-print" style="text-align: center; padding: 10px;">
        ...
        <a href="{{ route('admin.inventaris-iot-jaringan.show', $inventaris_iot_jaringan) }}" style="padding: 8px 20px; font-size: 12px; text-decoration: none; color: #333;">Kembali</a>
    </div>

    <div class="page">
        <div class="header">
            <h1>Riwayat Kartu Kendali Inventaris IoT & Jaringan</h1>
        ...
        <table class="info-table">
            <tr>
                ...
                <td>{{ $inventaris_iot_jaringan->kode_perangkat ?? $inventaris_iot_jaringan->id }}</td>
                <th>Nama Inventaris</th>
                <td>{{ $inventaris_iot_jaringan->nama_inventaris }}</td>
            </tr>
            <tr>
                <th>Kategori</th>
                <td>{{ $inventaris_iot_jaringan->kategori }}</td>
                <th>Jenis</th>
                <td>{{ $inventaris_iot_jaringan->jenis }}</td>
            </tr>
            <tr>
                <th>Lokasi</th>
                <td>{{ $inventaris_iot_jaringan->lokasi ?: '-' }}</td>
