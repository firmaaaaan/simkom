...
@section('title', 'Manajemen Komponen Jaringan')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Manajemen Komponen Jaringan</h4>
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <form method="GET" action="{{ route('admin.komponen-jaringan.index') }}" class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.komponen-jaringan.index') }}" class="btn btn-outline-secondary btn-sm" title="Reset">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Daftar Komponen Jaringan</h5>
                <div class="d-flex gap-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('admin.komponen-jaringan.import.form') }}" class="dropdown-item">
                                    <i class="bx bx-upload me-2"></i> Import Data
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.komponen-jaringan.export.excel', request()->query()) }}" class="dropdown-item">
                                    <i class="bx bx-file me-2"></i> Download Template Excel
                                </a>
                            </li>
                        </ul>
                    </div>
                    <a href="{{ route('admin.komponen-jaringan.export.excel', request()->query()) }}" class="btn btn-success">
                        <i class="bx bx-file me-1"></i> Export Excel
                    </a>
                    <a href="{{ route('admin.komponen-jaringan.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a href="{{ route('admin.komponen-jaringan.edit', ['komponen_jaringan' => $item->id]) }}" class="btn btn-sm btn-warning">
                                            <i class="bx bx-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-delete-action="{{ route('admin.komponen-jaringan.destroy', ['komponen_jaringan' => $item->id]) }}">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <p>Tidak ada data komponen Jaringan.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
