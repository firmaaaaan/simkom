...
<head>
    ...
    <title>Tiket {{ $ticket->tracking_code }} - {{ config('app.name', 'SimLab') }}</title>
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-6 text-white mb-6 shadow-lg shadow-orange-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-gray-100">
                        <div>
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">{{ $ticket->category }}</span>
                        </div>
                        <div>
                            ...
                            @endphp
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $priorityColors[$ticket->priority] ?? '' }}">{{ $ticket->priority }}</span>
                        </div>
                        <div>
            ...
            <div class="space-y-6">
                        ...
                        @foreach($statuses as $idx => $status)
                            <div class="flex items-start gap-3">
                                <div class="flex flex-col items-center">
                                    <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold {{ $idx <= $currentIdx ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-400' }}">
                                        @if($idx < $currentIdx)
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <h4 class="text-sm font-bold text-gray-900 mb-4">Informasi</h4>
