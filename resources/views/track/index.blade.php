...
<head>
    ...
    <title>Lacak Laporan - SimKom - UPT Lab Terpadu</title>
    ...
    <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-green-200">
                    <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                </div>
                <h1 class="text-2xl font-black text-gray-900 mb-2">Lacak Laporan</h1>
                <p class="text-gray-500">Masukkan kode tracking untuk melihat status laporan atau peminjaman Anda</p>
            </div>
                ...
                <form action="{{ route('track.search') }}" method="GET" class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="tracking_code" required
                            ...
                            placeholder="TKT-XXXXXXXX atau BMJ-XXXXXXXX"
                            class="w-full px-4 py-3 text-center text-lg font-mono font-bold tracking-wider border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 uppercase"
                            maxlength="13">
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-gray-400">
                        <div class="flex items-center gap-2 p-2 bg-orange-50 rounded-lg">
                            <span class="font-mono font-bold text-orange-600">TKT-</span>
                            <span>Kode Tiket Kendala</span>
                        </div>
                        <div class="flex items-center gap-2 p-2 bg-blue-50 rounded-lg">
                            <span class="font-mono font-bold text-blue-600">BMJ-</span>
                            <span>Kode Peminjaman</span>
                        </div>
                    </div>

                    <button type="submit"
                        class="w-full px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all shadow-lg shadow-green-200 hover:shadow-green-300">
                        Lacak Sekarang
                    </button>
                </form>
            </div>
            ...
            <div class="text-center mt-6">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-green-600 transition-colors">
