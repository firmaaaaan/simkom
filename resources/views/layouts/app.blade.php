    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-30 w-64 bg-green-800 text-white flex flex-col transition-transform duration-300 -translate-x-full lg:translate-x-0" id="sidebar">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                <p class="text-[10px] font-bold text-green-400 uppercase tracking-wider px-3 pt-4 pb-1">Monitoring</p>
                <a href="{{ route('monitoring-pc.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('monitoring-pc.*') ? 'bg-green-700/50 text-white' : 'text-green-200 hover:bg-green-700/30' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
